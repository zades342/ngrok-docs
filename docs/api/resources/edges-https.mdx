...
import EdgesHTTPSDeleteResponse from "./examples/_edges_https_delete_response.md";
...
| `mutual_tls`      | [EndpointMutualTLSMutate](#endpointmutualtlsmutate-parameters)           | edge modules                                                                            |
| `tls_termination` | [EndpointTLSTerminationAtEdge](#endpointtlsterminationatedge-parameters) |                                                                                         |
...
| `hostports`       | List&lt;string&gt;                                       | hostports served by this edge                                                           |
| `mutual_tls`      | [EndpointMutualTLS](#endpointmutualtls-fields)           | edge modules                                                                            |
| `tls_termination` | [EndpointTLSTermination](#endpointtlstermination-fields) |                                                                                         |
| `routes`          | [HTTPSEdgeRoute](#httpsedgeroute-fields)                 | routes                                                                                  |
...
| `jwt_validation`          | [EndpointJWTValidation](#endpointjwtvalidation-fields)                 | jwt validation module configuration or `null`                                           |
| `policies`                | [EndpointPolicies](#endpointpolicies-fields)                           | policies module configuration or `null`                                                 |
...
| Name            | Type                           | Description                                            |
| --------------- | ------------------------------ | ------------------------------------------------------ |
| `https_edges`   | [HTTPSEdge](#httpsedge-fields) | the list of all HTTPS Edges on this account            |
