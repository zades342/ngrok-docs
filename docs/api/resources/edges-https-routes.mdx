...
| `jwt_validation`          | [EndpointJWTValidation](#endpointjwtvalidation-parameters)                 | jwt validation module configuration or `null`                                           |
| `policies`                | [EndpointPolicies](#endpointpolicies-parameters)                           | policies module configuration or `null`                                                 |
...
#### EndpointJWTValidation parameters
