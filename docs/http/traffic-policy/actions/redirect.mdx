...
When executed this action will abort the request and replace all matches on the request URL with the configured replacements. Before regular expression replacement occurs, all named variables will be replaced with their corresponding values.
