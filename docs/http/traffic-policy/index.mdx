...
of rules that can be used to influence and control traffic
...
Policy rules are evaluated sequentially in the order they are configured with `on_tcp_connect` and `on_http_request` rules taking effect before the
...
| --------------- | ---------------------------------------------------------------------------------------------------------------------- |
| **on_tcp_connect**     | A list of policy rules that will be applied to on_tcp_connect traffic in the order specified.                                 |
| **on_http_request**    | A list of policy rules that will be applied to on_http_request traffic in the order specified.                                |
| **on_http_response**    | A list of policy rules that will be applied to on_http_response traffic in the order specified.                                |
...
- [Traffic Policy Edge Module API Resource](/api/resources/edge-route-policy-module/)
